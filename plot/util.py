...
def plt_VBretrieval_synthetic(PFT_uni    ,output_directory, Expname,
    ...
    axs[0,0].set_xticklabels(list(PFT_uni), rotation = 70, fontsize = 12)
    axs[0,0].set_ylabel(r'V$_{\rm c,max25}$ ($\mu$mol m$^{-2}$ s$^{-1})$', fontsize = 12)
    axs[0,0].tick_params(labelsize = 12,  axis='both', which='major', pad=0.0)
    axs[0,0].set_title(r'(a) Maximum Carboxylation Rate at 25$^\circ$C', fontsize = 14 )
    axs[0,0].legend()
    ...
    axs[1,0].set_title(r'(c) Soil Water Stress ($\beta_{\rm t}$)', fontsize = 14 )
    axs[1,0].set_xlabel('Actual' ,fontsize = 12)
    axs[1,0].set_ylabel('Recovered' ,fontsize = 12)
    ...
    axs[0,1].set_xlabel('Actual', fontsize =12)
    axs[0,1].set_ylabel('Recovered', fontsize = 12)
    axs[0,1].set_title('(b) Parameter B', fontsize = 14)
    ...
    axs[1,1].set_xlabel(r'Actual A$_{\rm n}$ ($\mu$mol m$^{-2}$ s$^{-1})$', fontsize = 12)
    axs[1,1].set_ylabel(r'Simulated A$_{\rm n}$ ($\mu$mol m$^{-2}$ s$^{-1})$', fontsize = 12)
    axs[1,1].set_title(r'(d) Net Photosynthesis Rate', fontsize = 14)
